...
## 2026-03-20 - v3.10.0 Kirilma Analizi ve PatternWatch
- Yeni modul: `breakpoint_agent.py` (10/20/30 tur kirilma analizi, ozel tas mantik skoru, toplam-9 niyeti, gelecek tas plan metrikleri).
- Yeni modul: `pattern_watch_agent.py` (oyundan bagimsiz surekli log tarama, warning sinyali, guidance agirlik katkisi).
- Robot kararina hamle-oncesi aday snapshot logu eklendi: `candidate_snapshot`.
- Log semasina gelecek tas baglami eklendi: `future_numbers`.
- Gazi guidance katmanina iki yeni birlestirme eklendi: `breakpoint` + `pattern_watch`.
